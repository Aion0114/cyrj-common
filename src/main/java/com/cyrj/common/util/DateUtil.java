...
//            logger.fatal(e.getMessage(), e);
     ...
     * @return
     */
    public static int getIntervalMinutes(Date maxDate, Date minDate)
    {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try
        {
...
//        Date dateStr = DateUtil.parseDate("2020-05-11 12");
        String dateStr = DateUtil.getFirstDayOfMonth(2020,12);
         dateStr = DateUtil.getLastDayOfMonth(2020,12);
        System.out.println(dateStr);
    }
}
